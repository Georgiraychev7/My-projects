...
public class AdminLoginSteps {
    ...
    public void theCurrentUserIsOnTheAdminLoginPage() {
        com.bdd.BDDFundTransfer.Browser.driver.get("http://shop.pragmatic.bg/admin/");
    }
    ...
    public void theUserLogsInUsingUsernameAndPassword(String username, String password) {
        com.bdd.BDDFundTransfer.Browser.driver.findElement(LOC_USERNAME).sendKeys(username);
        com.bdd.BDDFundTransfer.Browser.driver.findElement(LOC_PASSWORD).sendKeys(password);
    }
    ...
    public void theUserClicksOnTheLoginButton() {
        com.bdd.BDDFundTransfer.Browser.driver.findElement(LOC_LOGIN_BUTTON).click();
    }
    ...
    public void theUserShouldSuccessfullyLogInIntoTheAdminPanel() {
        String actualDashboardTitle = com.bdd.BDDFundTransfer.Browser.driver.getTitle();
    ...
    public void afterThatILogoutFromTheAdminPanel() {
        com.bdd.BDDFundTransfer.Browser.driver.findElement(LOC_LOGOUT_BUTTON).click();
    }
    ...
    public void theUserLoginShouldBeUnsuccessfulAndTheErrorMessageShouldContain(String errorMessage) {
        String actualError = com.bdd.BDDFundTransfer.Browser.driver.findElement(LOC_ERR_VALID_MSG).getText();
